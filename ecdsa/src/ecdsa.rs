...
mod test {
    ...
    fn test_secp256_sign_verify_tempered_message() {
        ...
        assert!(
            !verify_result,
            "Verification should have fail due to tempered message"
        );
    }
    ...
    fn test_secp256_sign_verify_tempered_signature() {
        ...
        assert!(
            !verify_result,
            "Verification should have fail due to tempered signature"
        );
    }
}
